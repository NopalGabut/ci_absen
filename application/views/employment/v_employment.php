                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="txdepartment" class="form-control" name="city-column" aria-placeholder="Pilih Department" onchange="load_atasan(this.value)" > 
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="txatasan" class="form-control" name="city-column" aria-placeholder="Pilih Atasan"> 
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
